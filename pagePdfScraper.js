...
async function scrapePdf(data) {
  ...
  const t = (dataUrl) => new Promise(async(resolve, reject) => {
    ...
    await page.evaluate(async () => {
      ...
      function arrayBufferToString(buffer) { // Convert an ArrayBuffer to an UTF-8 String
        ...
        let geturl = 'https://cuentosinfantiles.top/wp-content/uploads/cuentos_digital/Peter%20Pan.pdf';
